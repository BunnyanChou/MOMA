...
from src.momamatcher.backbone.feature_interaction import FeatureAttention
        ...
        for bs_id in range(self.bs):
            if (overlap_scores1[bs_id] > overlap_scores0[bs_id]
                ...
                if len(bs_j_ids1_l1) > 0:
                    ...
                    # fine level feature
                    bs_kptsfeat1 = feat_map1_unfold[bs_b_ids1_l1, bs_j_ids1_l1].flatten(1, 2)  # [k, ww, c]
                    bs_kptsfeat0_from1 = feat_map0_unfold[bs_b_ids1_l1, bs_i_ids1_l1].flatten(1, 2)  # [k, nwnw, c]
                    bs_feat_c = self.down_proj(
                        torch.cat([feat_d8_0[bs_b_ids1_l1, bs_i_ids1_l1], feat_d8_1[bs_b_ids1_l1, bs_j_ids1_l1]],dim=0))  # [2n, 2c->c]
